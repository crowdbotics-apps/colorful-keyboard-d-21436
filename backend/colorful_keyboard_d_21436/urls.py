"""colorful_keyboard_d_21436 URL Configuration
...
admin.site.site_header = "Colorful keyboard designs"
admin.site.site_title = "Colorful keyboard designs Admin Portal"
admin.site.index_title = "Colorful keyboard designs Admin"

# swagger
api_info = openapi.Info(
    title="Colorful keyboard designs API",
    default_version="v1",
    description="API documentation for Colorful keyboard designs App",
)
